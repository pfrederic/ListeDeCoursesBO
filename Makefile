...
# Generated by qmake (2.01a) (Qt 4.6.3) on: ven. mai 30 16:36:11 2014
# Project:  BOLDC.pro
# Template: app
...
$(TARGET): ui_mainwindow.h ui_login.h ui_magasin.h ui_rayon.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/BOLDC1.0.0/ && $(COPY_FILE) --parents mainwindow.h login.h magasin.h rayon.h .tmp/BOLDC1.0.0/ && $(COPY_FILE) --parents images.qrc .tmp/BOLDC1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp login.cpp magasin.cpp rayon.cpp .tmp/BOLDC1.0.0/ && $(COPY_FILE) --parents mainwindow.ui login.ui magasin.ui rayon.ui .tmp/BOLDC1.0.0/ && (cd `dirname .tmp/BOLDC1.0.0` && $(TAR) BOLDC1.0.0.tar BOLDC1.0.0 && $(COMPRESS) BOLDC1.0.0.tar) && $(MOVE) `dirname .tmp/BOLDC1.0.0`/BOLDC1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/BOLDC1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_login.cpp moc_magasin.cpp moc_rayon.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_login.cpp moc_magasin.cpp moc_rayon.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_login.h ui_magasin.h ui_rayon.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_login.h ui_magasin.h ui_rayon.h
